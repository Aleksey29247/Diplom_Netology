...
class CreatingClaimsTest {
    ...
    fun TitleEditText50CharTest() {
        device.findObject(By.res("ru.iteco.fmhandroid:id/title_edit_text")).text =
            "aaaaaaaasaasdaad"
    ...
    fun TitleEditTextMore50CharRusTest() {
        device.findObject(By.res("ru.iteco.fmhandroid:id/title_edit_text")).text =
            "ввввввввввыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыыы"
        device.findObject(By.res("ru.iteco.fmhandroid:id/save_button")).click()
        Thread.sleep(2000)
        assertEquals(device.findObject(By.text("Fill empty fields")).text, "Fill empty fields")
    }
    ...
    @Test
    fun DataTest() {
        device.findObject(By.res("ru.iteco.fmhandroid:id/date_in_plan_text_input_edit_text")).text =
            "01.07.1900"
        device.findObject(By.res("ru.iteco.fmhandroid:id/save_button")).click()
        Thread.sleep(2000)
        assertEquals(device.findObject(By.text("Fill empty fields")).text, "Fill empty fields")
    ...
    @Test
    fun TimeTest() {
        device.findObject(By.res("ru.iteco.fmhandroid:id/time_in_plan_text_input_edit_text")).text =
            "20:00"
        device.findObject(By.res("ru.iteco.fmhandroid:id/save_button")).click()
        Thread.sleep(2000)
        assertEquals(device.findObject(By.text("Fill empty fields")).text, "Fill empty fields")

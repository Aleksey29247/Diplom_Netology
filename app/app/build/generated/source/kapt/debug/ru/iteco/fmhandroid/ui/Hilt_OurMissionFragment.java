 ...
 */
public abstract class Hilt_OurMissionFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OurMissionFragment() {
    super();
  }

  Hilt_OurMissionFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OurMissionFragment_GeneratedInjector) this.generatedComponent()).injectOurMissionFragment(UnsafeCasts.<OurMissionFragment>unsafeCast(this));
    }
  }

 ...
 */
public abstract class Hilt_FilterNewsListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_FilterNewsListFragment() {
    super();
  }

  Hilt_FilterNewsListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FilterNewsListFragment_GeneratedInjector) this.generatedComponent()).injectFilterNewsListFragment(UnsafeCasts.<FilterNewsListFragment>unsafeCast(this));
    }
  }

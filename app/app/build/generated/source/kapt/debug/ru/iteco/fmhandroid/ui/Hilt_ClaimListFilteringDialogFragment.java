 ...
 */
public abstract class Hilt_ClaimListFilteringDialogFragment extends DialogFragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClaimListFilteringDialogFragment() {
    super();
  }

  Hilt_ClaimListFilteringDialogFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClaimListFilteringDialogFragment_GeneratedInjector) this.generatedComponent()).injectClaimListFilteringDialogFragment(UnsafeCasts.<ClaimListFilteringDialogFragment>unsafeCast(this));
    }
  }

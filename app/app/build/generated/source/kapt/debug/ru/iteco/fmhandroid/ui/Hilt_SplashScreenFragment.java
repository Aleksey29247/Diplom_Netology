 ...
 */
public abstract class Hilt_SplashScreenFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SplashScreenFragment() {
    super();
  }

  Hilt_SplashScreenFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SplashScreenFragment_GeneratedInjector) this.generatedComponent()).injectSplashScreenFragment(UnsafeCasts.<SplashScreenFragment>unsafeCast(this));
    }
  }

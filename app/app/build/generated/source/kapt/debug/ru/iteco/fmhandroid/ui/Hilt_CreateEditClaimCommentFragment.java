 ...
 */
public abstract class Hilt_CreateEditClaimCommentFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreateEditClaimCommentFragment() {
    super();
  }

  Hilt_CreateEditClaimCommentFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateEditClaimCommentFragment_GeneratedInjector) this.generatedComponent()).injectCreateEditClaimCommentFragment(UnsafeCasts.<CreateEditClaimCommentFragment>unsafeCast(this));
    }
  }

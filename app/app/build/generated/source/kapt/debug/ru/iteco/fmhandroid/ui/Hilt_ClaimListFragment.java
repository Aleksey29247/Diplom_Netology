 ...
 */
public abstract class Hilt_ClaimListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ClaimListFragment() {
    super();
  }

  Hilt_ClaimListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ClaimListFragment_GeneratedInjector) this.generatedComponent()).injectClaimListFragment(UnsafeCasts.<ClaimListFragment>unsafeCast(this));
    }
  }

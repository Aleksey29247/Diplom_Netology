 ...
 */
public abstract class Hilt_CreateEditClaimFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreateEditClaimFragment() {
    super();
  }

  Hilt_CreateEditClaimFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateEditClaimFragment_GeneratedInjector) this.generatedComponent()).injectCreateEditClaimFragment(UnsafeCasts.<CreateEditClaimFragment>unsafeCast(this));
    }
  }

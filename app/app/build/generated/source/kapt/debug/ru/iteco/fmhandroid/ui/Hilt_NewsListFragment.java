 ...
 */
public abstract class Hilt_NewsListFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewsListFragment() {
    super();
  }

  Hilt_NewsListFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewsListFragment_GeneratedInjector) this.generatedComponent()).injectNewsListFragment(UnsafeCasts.<NewsListFragment>unsafeCast(this));
    }
  }

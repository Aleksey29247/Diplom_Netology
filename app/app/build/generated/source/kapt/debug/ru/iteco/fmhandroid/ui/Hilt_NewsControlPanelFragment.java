 ...
 */
public abstract class Hilt_NewsControlPanelFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_NewsControlPanelFragment() {
    super();
  }

  Hilt_NewsControlPanelFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NewsControlPanelFragment_GeneratedInjector) this.generatedComponent()).injectNewsControlPanelFragment(UnsafeCasts.<NewsControlPanelFragment>unsafeCast(this));
    }
  }

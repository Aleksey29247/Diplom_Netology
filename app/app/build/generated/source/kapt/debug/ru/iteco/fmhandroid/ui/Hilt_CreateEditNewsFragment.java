 ...
 */
public abstract class Hilt_CreateEditNewsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_CreateEditNewsFragment() {
    super();
  }

  Hilt_CreateEditNewsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CreateEditNewsFragment_GeneratedInjector) this.generatedComponent()).injectCreateEditNewsFragment(UnsafeCasts.<CreateEditNewsFragment>unsafeCast(this));
    }
  }

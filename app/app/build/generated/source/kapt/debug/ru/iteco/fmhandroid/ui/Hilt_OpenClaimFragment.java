 ...
 */
public abstract class Hilt_OpenClaimFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_OpenClaimFragment() {
    super();
  }

  Hilt_OpenClaimFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((OpenClaimFragment_GeneratedInjector) this.generatedComponent()).injectOpenClaimFragment(UnsafeCasts.<OpenClaimFragment>unsafeCast(this));
    }
  }

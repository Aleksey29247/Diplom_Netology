...
public class ClaimListFragmentDirections private constructor() {
  private data class ActionClaimListFragmentToOpenClaimFragment(
    ...
    public override val actionId: Int = R.id.action_claimListFragment_to_openClaimFragment
  ...
  private data class ActionClaimListFragmentToCreateEditClaimFragment(
    ...
    public override val actionId: Int = R.id.action_claimListFragment_to_createEditClaimFragment
  ...
  private data class ActionClaimListFragmentToNewsListFragment(
    ...
    public override val actionId: Int = R.id.action_claimListFragment_to_newsListFragment

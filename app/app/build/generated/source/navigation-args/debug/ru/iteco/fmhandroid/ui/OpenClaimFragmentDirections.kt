...
public class OpenClaimFragmentDirections private constructor() {
  ...
  private data class ActionOpenClaimFragmentToCreateEditClaimFragment(
    ...
    public override val actionId: Int = R.id.action_openClaimFragment_to_createEditClaimFragment
  ...
  private data class ActionOpenClaimFragmentToNewsListFragment(
    ...
    public override val actionId: Int = R.id.action_openClaimFragment_to_newsListFragment
  ...
  public companion object {
    public fun actionOpenClaimFragmentToCreateEditClaimCommentFragment(argClaimId: Int,
        argComment: ClaimComment? = null): NavDirections =
        ActionOpenClaimFragmentToCreateEditClaimCommentFragment(argClaimId, argComment)
